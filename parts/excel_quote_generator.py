...
def generate_work_ticket(job_info,fixture_info):
    ...
    # worksheet.write('C13','DISHWASHER INSTALLTION')
    # worksheet.write('D13',125,num_format)
    # worksheet.write('E13','=B13*D13',num_format)

    # worksheet.write('B14',1,quantity)
    # worksheet.write('C14','ICE MAKERBOX FOR REFRIGERATOR')
    ...
    #     worksheet.write(f'C{line}',f'{fixture_info['bath']['closet']['closet']} CLOSET')
    ...
    #                 # shower base only
    #                 worksheet.write(f'B{line}',1,quantity)
    #                 worksheet.write(f'C{line}',f'{fixture_info['bath']['brand']} {fixture_info['bath']['shower']['shower_base']} {bathrooms[i]['clean']['size']} WHITE SHOWER BASE ONLY')
    ...
    #                 # separate walls
    #                 worksheet.write(f'B{line}',1,quantity)
    #                 worksheet.write(f'C{line}',f'{fixture_info['bath']['brand'].upper} {fixture_info['bath']['shower']['shower_coll']} {fixture_info['bath']['shower']['shower_base']}/{fixture_info['bath']['shower']['shower_back_wall']}/{fixture_info['bath']['shower']['shower_end_wall']}')
    ...
    #             worksheet.write(f'D{line}',f'=((({fixture_info['bath']['lavatory']['ped_lav_bowl_cost']}+{fixture_info['bath']['lavatory']['ped_lav_leg_cost']})*1.04)*1.07)/{fixture_info['markup']}',num_format)
    #             worksheet.write(f'E{line}',f'=B{line}*D{line}',num_format)
    #             line +=1
    #             # bowl
    ...
    # line+=1
    # # water
    # worksheet.write(f'C{line}','IF WATER IS NOT AVAILABLE FOR SLAB AND ROUGH TESTING:')
    # line+=1
